...
## Project Structure
    ...
    ├── testappforcheck_de_122763  # Django project configurations
...
1. Clone this repo and `cd testappforcheck_de_122763`
...
2. Clone this repo and `cd testappforcheck_de_122763`
